...
if TYPE_CHECKING:
    from src.spacecat.platforms.discord.instance import Instance
    from src.spacecat.platforms.discord.modules.musicbox.playlist import Playlist, PlaylistSong
