...
from src.spacecat.platforms.discord.modules.musicbox.music_player import (
    OriginalSource,
    PlayerResult,
    Song,
    SongUnavailableError,
)
from src.spacecat.platforms.discord.modules.musicbox.players.wavelink_player import WavelinkMusicPlayer, WavelinkSong
from src.spacecat.platforms.discord.modules.musicbox.playlist import (
    Playlist,
    PlaylistRepository,
    PlaylistSong,
...
if TYPE_CHECKING:
    ...
    from src.spacecat.platforms.discord.modules.musicbox.music_player import MusicPlayer
